          ...
          <>
            ...
            <ModalBody>
              <form onSubmit={createPlaylist}>
                ...
                >
                  <SelectItem color="success" className="!text-white" value="public" startContent={<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>}>
                    {t('public')}
                  </SelectItem>
                  <SelectItem color="danger" value="private" startContent={<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>}>
                    {t('private')}
                  </SelectItem>
                </Select>
              </form>
            ...
            <ModalFooter>
              ...
              <Button color="primary" type="submit" onClick={createPlaylist} onPress={onClose}>
                {t('create')}
              </Button>
            </ModalFooter>
          </>

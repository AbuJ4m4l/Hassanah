...
const PlayLists = () => {
  ...
  const {
    ...
    onOpen: onCreateNewPlaylistModalOpen,
    onOpenChange: onCreateNewPlaylistModalOpenChange,
  } = useDisclosure();
  const {
    isOpen: isEditPlaylistModalOpen,
    onOpen: onEditPlaylistModalOpen,
    onOpenChange: onEditPlaylistModalOpenChange,
  } = useDisclosure();
  const {
    isOpen: isDeletePlaylistModalOpen,
    onOpen: onDeletePlaylistModalOpen,
    onOpenChange: onDeletePlaylistModalOpenChange,
  } = useDisclosure();
  ...
  return (
    <section role="tab">
      <div className="mt-6 flex justify-center">
        <h1 className="text-xl md:text-2xl">{t("playlists")}</h1>
      </div>
      <div className="flex flex-col">
        <div>
          <Button
            onClick={onCreateNewPlaylistModalOpen}
            variant="flat"
            color="default"
          >
            <svg
        ...
        <Skeleton isLoaded={isLoaded} className="rounded-lg mt-6 mx-2 md:mx-8">
          <Table selectionMode="single" color="default" aria-label="Playlists">
            <TableHeader>
              <TableColumn>
                <p className="flex justify-center">{t("playlist_name")}</p>
              </TableColumn>
              <TableColumn>
                <p className="flex justify-center">{t("total_surahs")}</p>
              </TableColumn>
              <TableColumn>
                <p className="flex justify-center">{t("visibility")}</p>
              </TableColumn>
              <TableColumn>
                <p className="flex justify-center">{t("actions")}</p>
              </TableColumn>
              <TableColumn>
                <p className="flex justify-center">{t("created_At")}</p>
              </TableColumn>
            </TableHeader>

        ...
        <div className="w-[300px] md:w-[400px]">
          ...
          <Skeleton isLoaded={loading === false ? true : false} className="rounded-lg mt-2">
            <Input
              ...
              value={user?.email}
              endContent={
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
              }
            />
          </Skeleton>
        </div>
                    ...
                    <Skeleton isLoaded={loading === false ? true : false} className="rounded-lg mt-2">
                      <Link className="w-[300px] md:w-[400px]" href="/change-password">
                        <Input
                          ...
                          value="*******"
                          endContent={
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                          }
                        />
                      </Link>
                    </Skeleton>

...
import {
    Alexandria, Almarai, Amiri, Aref_Ruqaa, Changa, El_Messiri,
    IBM_Plex_Sans_Arabic, Katibeh, Kufam, Lateef, Marhey, Noto_Sans,
    Readex_Pro, Rubik, Scheherazade_New, Tajawal
...
const readex_pro = Readex_Pro({ subsets: ["arabic", "latin"], weight: ["400"] });
...
const alexandria = Alexandria({ subsets: ["arabic", "latin"], weight: ["400"] });
const el_messiri = El_Messiri({ subsets: ["arabic", "latin"], weight: ["400"] });
const scheherazade_new = Scheherazade_New({ subsets: ["arabic", "latin"], weight: ["400"] });

const FontSwitcher = ({ className }) => {
    const [selectedFont, setSelectedFont] = useState({
        value: localStorage?.getItem('font') || "changa",
        label: localStorage?.getItem('font_label') ? localStorage?.getItem('font_label') : "Changa",
        font: localStorage?.getItem('font') ? localStorage?.getItem('font') : changa.className
    });
    ...
    const fonts = [
        ...
        { value: "ibm_plex_sans_arabic", label: "IBM Plex Sans Arabic", font: ibm_plex_sans_arabic.className },
        ...
        { value: "scheherazade_new", label: "Scheherazade New", font: scheherazade_new.className },
    ];
    ...
    return (
        <div className={className ?? className}>
            <Dropdown>
                <DropdownTrigger>
                    <Button
                        endContent={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-type"><polyline points="4 7 4 4 20 4 20 7"></polyline><line x1="9" y1="20" x2="15" y2="20"></line><line x1="12" y1="4" x2="12" y2="20"></line></svg>}
                        color="default"
                        variant="solid"

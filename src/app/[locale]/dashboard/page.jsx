...
import { faClockRotateLeft, faGear, faHeadphonesSimple, faMobileScreen, faShield, faUser } from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            <Tabs variant='unstyled' align='center' className='-mt-[40px]'>
                <TabList bgColor="#242424" height="60px" className="overflow-x-auto overflow-y-hidden w-full">
                    ...
                    <Tab _selected={{ color: 'white', bg: '#343434' }} _hover={{ color: 'white', bg: '#343434' }}><FontAwesomeIcon icon={faHeadphonesSimple} className='ltr:mr-2 rtl:ml-2' />{t('playlists')}</Tab>

            ...
            title={
              <div className="flex items-center ltr:space-x-2">
                <svg
                  ...
                  className="rtl:ml-2 feather feather-user"
                >
            ...
            title={
              <div className="flex items-center space-x-2">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="rtl:ml-2 feather feather-headphones"
                >
            ...
            title={
              <div className="flex items-center space-x-2">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="rtl:ml-2 feather feather-activity"
                >
            ...
            title={
              <div className="flex items-center space-x-2">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="rtl:ml-2 feather feather-settings"
                >
